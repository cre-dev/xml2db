...
CREATE TABLE "clickAndTradeDetails" (
	...
	"minimumExecuteVolume_value" DOUBLE PRECISION, 
	"minimumExecuteVolume_unit" VARCHAR(8), 
	"triggerDetails_priceLimit_value" DOUBLE PRECISION, 
	"triggerDetails_priceLimit_currency" VARCHAR(3), 
	"triggerDetails_triggerContractId" VARCHAR(50), 
	"undisclosedVolume_value" DOUBLE PRECISION, 
...
CREATE TABLE "TradeReport" (
	...
	"priceDetails_price" DOUBLE PRECISION, 
	"priceDetails_priceCurrency" VARCHAR(3), 
	"notionalAmountDetails_notionalAmount" DOUBLE PRECISION, 
	"notionalAmountDetails_notionalCurrency" VARCHAR(3), 
	quantity_value DOUBLE PRECISION, 
	quantity_unit VARCHAR(8), 
	"totalNotionalContractQuantity_value" DOUBLE PRECISION, 
